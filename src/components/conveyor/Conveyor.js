...
export class ConveyorDetailModal extends Component {
    ...
    render() {
        const { conveyorDetail } = this.state;
        const tableColumns = [
            { title: 'Name', prop: 'skuId'},
            { title: 'Target', prop: 'targetQuantity'},
            { title: 'In', prop: 'currentQuantity'}
        ]
            ...
            <div className="modal-content">
                ...
                <div className="modal-body">
                    ...
                    <DataTable
                        ...
                        initialData={conveyorDetail.details}
                        initialPageLength={10}
                        initialSortBy={{ prop: 'skuId', order: 'ascending' }}
